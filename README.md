...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/si-prefix-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11959&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/si-prefix-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `si-prefix` can be installed with:

```
conda install si-prefix
```

It is possible to list all of the versions of `si-prefix` available on your platform with:
